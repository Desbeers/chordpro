# generated by wxGlade 1.1.0b1 on Wed Oct 16 20:44:26 2024
#
...
sub new {
    ...
    $self->{Preview} = Wx::Button->new($self, wxID_ANY, "Preview", wxDefaultPosition, wxDefaultSize, wxBORDER_NONE);
    $self->{Preview}->SetBitmap(Wx::Bitmap->new("/Users/Desbeers/Github/Clones/ChordPro/lib/ChordPro/res/icons/a-settings-outline.png", wxBITMAP_TYPE_ANY));
    $self->{Preview}->SetBitmapPressed(Wx::Bitmap->new("/Users/Desbeers/Github/Clones/ChordPro/lib/ChordPro/res/icons/a-settings-outline-pressed.png", wxBITMAP_TYPE_ANY));
    $self->{sizer_4}->Add($self->{Preview}, 0, wxALL, 10);
    
    $self->{Messages} = Wx::Button->new($self, wxID_ANY, "Messages", wxDefaultPosition, wxDefaultSize, wxBORDER_NONE);
    ...
    $self->{p_left} = Wx::Panel->new($self->{sw_main}, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_NONE);
    ...
    $self->{sw_main}->SplitVertically($self->{p_left}, $self->{p_preview}, , 636);
    
    $self->SetSizer($self->{sz_main});
    $self->{sz_main}->Fit($self);
    
    $self->Layout();
    Wx::Event::EVT_BUTTON($self, $self->{Preview}->GetId, $self->can('OnPreview'));
