# generated by wxGlade 1.1.0b1 on Thu Oct 17 18:23:44 2024
#
...
sub new {
    ...
    $self->{Messages}->SetBitmap(Wx::Bitmap->new("/Users/Desbeers/Github/Clones/ChordPro/lib/ChordPro/res/icons/a-settings-outline.png", wxBITMAP_TYPE_ANY), wxTOP);
    ...
    $self->{sizer_4}->Add($self->{Messages}, 0, wxALL, 6);
    ...
    $self->{buttonPreview}->SetBitmap(Wx::Bitmap->new("/Users/Desbeers/Github/Clones/ChordPro/lib/ChordPro/res/icons/a-settings-outline.png", wxBITMAP_TYPE_ANY), wxTOP);
    ...
    $self->{sizer_4}->Add($self->{buttonPreview}, 0, wxALL, 6);
    ...
    $self->{Settings}->SetBitmap(Wx::Bitmap->new("/Users/Desbeers/Github/Clones/ChordPro/lib/ChordPro/res/icons/a-settings-outline.png", wxBITMAP_TYPE_ANY), wxTOP);
    ...
    $self->{sizer_4}->Add($self->{Settings}, 0, wxALL, 6);
